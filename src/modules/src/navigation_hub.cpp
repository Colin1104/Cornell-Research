...
int main(int argc, char** argv)
{
  ...
  //Elevation Mapping Stuffz
  ros::Subscriber pose_sub = node.subscribe("/rtabmap/odom", 15, odom_cb);
  pose_pub = node.advertise<geometry_msgs::PoseWithCovarianceStamped>("/robot_pose", 15);
